...
<div class="card">
    <div class="card-body">
        <form action="{{ route('chairperson.save_upload_esig', auth()->user()->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <a href="{{ route('chairperson.dashboard') }}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Return</a>
        </form>
    </div>
</div>
@endsection
